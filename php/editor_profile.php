...
echo '  </div>
        ...
        <div class="edit">
            <div>
                ...
                <input class="input-form" id="name" name="name" type="text" value="' . getUserById($_SESSION['uid'])['name'] . '">
            </div>
            ...
            <div>
                ...
                <input class="input-form" id="email" name="email" type="email" value="' . getUserById($_SESSION['uid'])['email'] . '">
            </div>
        </div>
    </form>
';